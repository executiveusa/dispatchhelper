...
import { UserCircle, LogOut, MessageSquare, BarChart3 } from "lucide-react";
  ...
  return (
    <nav className="fixed w-full z-50 bg-white/90 backdrop-blur-sm shadow-sm">
      <div className="container mx-auto flex items-center justify-between h-16">
        <Link to="/" className="flex items-center" aria-label="SPATCHY home">
          <img
            src="/spatchy-logo.svg"
            alt="SPATCHY"
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          {user && (
            <>
              ...
              <Link to="/dispatch" className="text-sm font-medium hover:text-primary">Management</Link>
              <Link to="/chat" className="text-sm font-medium hover:text-primary">Chat</Link>
            </>
          )}
        </div>
        ...
        <div className="flex items-center space-x-4">
          {user ? (
            <>
              <Link to="/pricing">
                <Button size="sm" className="bg-primary hover:bg-primary/90">Pricing</Button>
              </Link>
              <Link to="/profile">
